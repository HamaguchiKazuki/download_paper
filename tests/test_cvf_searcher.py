...
class TestCvfSearcher(unittest.TestCase):
    ...
    def test_cvpr_searcher(self):
        cvpr_sercher = CvfSearcher(conference_journal_name="CVPR")
    ...
    def test_wacv_searcher(self):
        wacv_sercher = CvfSearcher(conference_journal_name="WACV")
        year_list = ["2020", "2021"]
    ...
    def test_iccv_searcher(self):
        iccv_sercher = CvfSearcher(conference_journal_name="ICCV")
